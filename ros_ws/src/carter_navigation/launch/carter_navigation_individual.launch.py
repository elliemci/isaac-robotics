...
def generate_launch_description():
    ...
    # Get the carter navigation directory
    ...
    declare_map_yaml_cmd = DeclareLaunchArgument(
        "map",
        default_value=os.path.join(nav2_launch_dir, "maps", "warehouse_test_scene.yaml"),
    ...
    # Include Nova Carter robot description with Isaac Sim support
    nova_carter_description_cmd = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(carter_nav2_bringup_dir, "launch", "nova_carter_description_isaac_sim.launch.py")
        ),
        launch_arguments={
    ...
    ld.add_action(nova_carter_description_cmd)
