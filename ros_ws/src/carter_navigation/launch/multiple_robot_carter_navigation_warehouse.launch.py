...
def generate_launch_description():
    ...
    # Common settings
    ENV_MAP_FILE = "warehouse_test_scene.yaml"
    ...
    declare_robot1_params_file_cmd = DeclareLaunchArgument(
        ...
        default_value=os.path.join(
            carter_nav2_bringup_dir, "params", "carter_navigation_params_1.yaml"
        ),
    ...
    declare_robot2_params_file_cmd = DeclareLaunchArgument(
        "carter2_params_file",
        default_value=os.path.join(
            carter_nav2_bringup_dir, "params",  "carter_navigation_params_2.yaml"
        ),
    ...
    declare_robot3_params_file_cmd = DeclareLaunchArgument(
        "carter3_params_file",
        default_value=os.path.join(
            carter_nav2_bringup_dir, "params", "carter_navigation_params_3.yaml"
        ),
        ...
        group = GroupAction(
            [
                ...
                Node(
                    ...
                    remappings=[('cloud_in', [f'/{robot["name"]}/xt_32/point_cloud']),
                                ('scan', ['scan'])],
                    parameters=[{
